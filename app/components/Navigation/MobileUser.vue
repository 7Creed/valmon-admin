...
<template>
	<div class="mobile-navbar bg-black fixed top-0 left-0 right-0 z-[10000]">
		<div v-if="!showMenu" class="navbar bg-black">
			...
			<div class="navbar-end">
				<div class="flex justify-center items-baseline gap-5">
					...
					>
						<div class="avatar">
							<div
								class="ring-[1.5px] ring-brightGold w-8 rounded-full"
							>
								<img
			...
			>
				...
				>
					...
					>
						<div class="avatar">
							<div
								class="ring ring-offset-base-100 w-12 rounded-full"
							>
								<img
									:src="store?.UserAccount?.profile_pic"
									alt="Profile Pic"
					...
					<div class="flex flex-col">
						<NuxtLink to="/home" class="text-white font-semibold">
							Explore Skills
						</NuxtLink>
						...
						>
							<button
								class="btn btn-outline bg-inherit text-white"
							>
								Join Now
							</button>
						</NuxtLink>
