...
<template>
  <div class="hero h-[600px] lg:min-h-screen">
    ...
    <div class="hero-content text-white text-center">
      <div class="max-w-full relative">
        ...
        <img :src="rectangle" alt="" class="absolute rectangle w-14 lg:w-20 right-[12rem] lg:right-[17rem] ">
        ...
        <div class="text-base font-medium">
          <button
            ...
            @click="$router.push({ path: '/getstarted', query: { page: 'hireexpert' } })">
            <span class="text-base font-medium">Hire Expert</span>
            <img :src="rightArrow" alt="right arrow icon">
          </button>
          <button
            class="btn btn-outline bg-inherit text-white border-2 bg-gradient-to-r hover:from-[#C09742] hover:to-[#C09742] hover:border-[#CFB159] ms-5"
            @click="$router.push({ path: '/worker' })">
            <span class="text-base font-medium select2"> Sell Your Skills</span>
