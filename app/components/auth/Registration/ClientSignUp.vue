...
const { createUser, googleRedirect } = authController();
...
<template>
  <div class="">
    <div class="mb-9">
      <h1
        class="text-2xl lg:text-3xl font-bold text-[rgba(35, 35, 35, 1)] mb-2 text-center lg:text-left"
      >
        {{
    ...
    <form @submit.prevent="signUp" class="w-full">
      <div
        class="flex flex-col sm:flex-row justify-center items-center gap-2 mb-3"
      >
        <BaseInput
      ...
      <div class="gap-2 mb-3">
        ...
        <p v-if="!passwordMatch" class="mt-2 text-pink-600 text-sm">
    ...
    <p class="text-lg font-semibold text-center">
      ...
      <NuxtLink to="/login" class="text-darkGold"> Login </NuxtLink>
    </p>
  </div>
</template>
