...
const { getAllNotifications, getUnreadNotifications, markAsRead } =
...
<template>
	<div class="min-h-screen bg-gray-100 py-8 px-4 sm:px-6 lg:px-8">
		<div class="max-w-4xl mx-auto">
			<h1
				class="text-3xl text-center satoshiM font-bold text-gray-900 mb-8 flex items-center justify-between"
			>
