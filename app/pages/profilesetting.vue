		...
		<div class="flex gap-8 pb-20 pt-12 w-[90%] mx-auto">
				...
				>
					<div class="card-body">
						...
						>
							...
							<span class="text-[#67676D] text-sm"
			...
			>
				...
				<div class="lg:hidden flex justify-center gap-2">
					...
					<h1
						class="text-[#232323] font-bold text-2xl text-center center mb-5 satoshiM"
					>
						{{ tabTitle }}
					</h1>
				</div>
				<MarketPlaceEmployerPersonalInfo
					v-if="activeTab === 'personal'"
				/>
				<MarketPlaceEmployerActiveJobs v-if="activeTab === 'jobs'" />
				<MarketPlaceEmployerPaymentInfo
					v-if="activeTab === 'payment'"
				/>
				<MarketPlaceEmployerRestPassword
					v-if="activeTab === 'password'"
				/>
				<MarketPlaceEmployerNotificationSetting
